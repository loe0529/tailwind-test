  ...
  return (
    <section className="desktop-section-skill">
      <div className="desktop-section-skill-frame">
        <img src="/images/skill-icon1.svg" alt="" className="desktop-section-skill-icon1" />
        <img src="/images/skill-icon2.svg" alt="" className="desktop-section-skill-icon2" />
        <img src="/images/skill-icon3.svg" alt="" className="desktop-section-skill-icon3" />
        <img src="/images/skill-icon4.svg" alt="" className="desktop-section-skill-icon4" />
        <img src="/images/skill-icon5.svg" alt="" className="desktop-section-skill-icon5" />
